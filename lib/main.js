	...
	var menuItemAddTerm = cm.Item({
        ...
        onMessage: function(text) {
        	...
        	if (!setId) {
        		...
        		request.Request({
        			url: "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20150520T095829Z.0a7f4467b16aa50d.8cebb0ad825a5bda0dce118d9957014c025842c8&text=" + text.toLowerCase().trim() + "&lang=en-" + prefs.translationLanguage,
        			onComplete: function(response) {
